...
### 4. Add a file to the data folder and amend the previous commit to include the data folder. 

"git commit --amend -"message"" is used when you want to add some changes to the file with a different or update commit message. 

#### Here is how we can use git commit --amend 
1. Create and add a file into data folder 
2. run "git add data" to stage the new folder and its contents/files 
